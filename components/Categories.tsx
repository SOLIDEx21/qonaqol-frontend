...
const CATEGORIES = [
  ...
  { label: 'Dağ evləri', icon: Mountain },
  { label: 'Trend', icon: Flame },
  { label: 'Şatolar', icon: Castle },
  { label: 'Teknələr', icon: Sailboat },
  { label: 'Şəhər', icon: Building },
...
export default function Categories() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex items-center justify-start md:justify-center space-x-8 md:space-x-12 overflow-x-auto hide-scrollbar pb-2">
        {CATEGORIES.map((cat) => {
          ...
          return (
            <div
              ...
              className={`flex flex-col items-center gap-2 cursor-pointer transition-all min-w-max pb-2 border-b-2 hover:scale-105 ${
                isSelected
